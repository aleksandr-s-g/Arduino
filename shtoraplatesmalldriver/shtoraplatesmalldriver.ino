...
const int upBtnPin = 14;// номер контакта для кнопки
const int downBtnPin = 27;// номер контакта для кнопки
const int ReedS1Pin = 26;// номер контакта для кнопки
const int ReedS2Pin = 26;// номер контакта для 
const int En1Pin = 33;// номер контакта для кнопки
const int En2Pin = 32;// номер контакта для 
